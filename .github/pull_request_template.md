...
- [ ] New code follows nearby naming, layout, and data-flow patterns instead of adding one-off styles.
- [ ] Database or Docker changes include the exact rebuild/reload command in the PR notes.
